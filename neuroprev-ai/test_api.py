...
app = FastAPI(
    title="NeuroPrev AI API - Test Mode",
...
def root():
    """Endpoint raiz"""
    return {
        "message": "NeuroPrev AI API - Test Mode",
        "docs": "/docs",
        "health": "/health",
...
async def startup_event():
    print("\n" + "="*60)
    print("🚀 NeuroPrev AI API - Test Mode Iniciando...")
    print("="*60)
...
async def shutdown_event():
    print("\n" + "="*60)
    print("🛑 NeuroPrev AI API - Test Mode Finalizando...")
    print("="*60 + "\n")
