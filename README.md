...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/wagtail/codatasite/)
...
```bash
git clone https://github.com/wagtail/codatasite.git
cd codatasite
vagrant up
vagrant ssh
