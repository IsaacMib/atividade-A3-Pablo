# Athena - Sistema de IA Multimodal para Triagem de TEA

## 📋 Visão Geral

**Athena** é o sistema de Inteligência Artificial multimodal do NEUROATHENA para triagem precoce de Transtorno do Espectro Autista (TEA), combinando análise de **vídeo**, **áudio**, **texto** e **dados temporais** para gerar avaliações de risco precisas e explicáveis.
...
class AIAnalysisService:
    ...
    """
    API_BASE_URL = settings.ATHENA_AI_URL  # http://localhost:8001
