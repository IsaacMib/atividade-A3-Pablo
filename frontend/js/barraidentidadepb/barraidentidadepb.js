export default class BarraIdentidade {
  ...
  toggleOrgaosGoverno() {
    ...
    if (
      ...
      if (
        ...
        o.classList.add('mostra-orgaos'), i.classList.add('link-cima-barra');
      }
    }
  }
  ...
  checkScrollBarra(a) {
    if (a.scrollLeft <= 0) {
      ...
      a.scrollLeft > 0 &&
      a.scrollLeft < a.scrollWidth - a.clientWidth - 20
    ) {
      document.getElementById('botao-seta-direita').style.display = 'block';
  ...
  initBarra() {
    ...
    if (barraBrasil) {
      barraBrasil.innerHTML = `<div class="conteudo-escondido"> <a accesskey="1" href="#conteudo">Ir para o conteúdo</a> </div>
        <div class="conteudo-barra-brasil w-[95%] max-w-6xl">
