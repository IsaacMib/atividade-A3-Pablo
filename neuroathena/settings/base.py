"""
Django settings for neuroathena project.
...
INSTALLED_APPS = [
    ...
    "institucional",       # Institucional: Sobre Nós, Missão, Equipe, Parcerias, Localização
    "responsaveis",       # Página Para Famílias (Triagem, Recursos)
    "profissionais",       # Página Para Profissionais (Suíte Clínica, API)
    "ia_multimodal",       # Página IA Multimodal Athena (Explicação técnica)
    "contato",             # Página de Contato (Formulário)
    
    # Apps auxiliares/genéricos
    "paginas",             # Páginas genéricas reutilizáveis (CorpoTecnico, RichText, Banner, Redirect)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "neuroathena.context_processors.versao_context",
            ],
        },
    },
]

WSGI_APPLICATION = "neuroathena.wsgi.application"
...
WAGTAIL_SITE_NAME = "NEUROATHENA - Sistema de Triagem de Autismo com IA"
...
# Quando implementar SSO no NEUROATHENA, criar novo adapter
# ACCOUNT_ADAPTER = "auth_keycloak.adapters.KeycloakAdapter"

KEYCLOAK_BASE_URL = os.getenv("KEYCLOAK_BASE_URL", "")  # SSO desativado para NEUROATHENA
...
SOCIALACCOUNT_PROVIDERS = {
    "openid_connect": {
        "APPS": [
            {
                "provider_id": os.getenv("SOCIALACCOUNT_PROVIDER_ID", "neuroathena-sso"),
                "name": os.getenv("SOCIALACCOUNT_NAME", "NEUROATHENA SSO"),
...
# Django Tasks - Backend configurado
# Fix para Python 3.11 compatibilidade
TASKS = {
    "default": {
