...
cp $PROJECT_DIR/delegaciadamulher/settings/local.py.example $PROJECT_DIR/delegaciadamulher/settings/local.py
...
then
    ...
    cat << EOF >> $PROJECT_DIR/delegaciadamulher/settings/local.py
DATABASES = {
    'default': {
